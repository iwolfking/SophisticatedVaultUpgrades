...
public class IdentificationUpgradeItem extends UpgradeItemBase<IdentificationUpgradeWrapper> {
    ...
    public IdentificationUpgradeItem(CreativeModeTab itemGroup, IdentificationUpgradeConfig identificationUpgradeConfig, IUpgradeCountLimitConfig upgradeTypeLimitConfig) {
