...
public class OpenerUpgradeContainer extends UpgradeContainerBase<OpenerUpgradeWrapper, OpenerUpgradeContainer> {
    ...
    public OpenerUpgradeContainer(Player player, int containerId, OpenerUpgradeWrapper wrapper, UpgradeContainerType<OpenerUpgradeWrapper, OpenerUpgradeContainer> type) {
